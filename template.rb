...
module SessionTestHelper
  ...
  if test_framework == "rspec"
    ...
    file "spec/fixtures/users.yml", ERB.new(
    *[
  <<~'TCODE'
# Password for both users is: Secret1*3*5*
one:
...
if use_system_tests
  ...
  if use_starter_kit
    if test_framework == "rspec"
      file "spec/system/sessions_spec.rb", ERB.new(
    *[
  <<~'TCODE'
# frozen_string_literal: true
...
RSpec.describe "Sessions", type: :system do
  ...
  TCODE
      ...
      file "test/system/sessions_test.rb", ERB.new(
    *[
  <<~'TCODE'
